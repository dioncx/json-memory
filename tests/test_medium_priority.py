...
class TestContradictionDetection:
    ...
    def test_same_subject_same_attribute_contradiction(self):
        ...
        contradictions = detect_contradictions("user.status", "inactive", {"user.status": "active"})
    ...
    def test_different_subjects_no_contradiction(self):
        ...
        contradictions = detect_contradictions("bot.running", "no", {"user.status": "active"})
        assert len(contradictions) == 0
    ...
    def test_same_subject_different_attributes_no_contradiction(self):
        ...
        contradictions = detect_contradictions("user.name", "Dion", {"user.status": "active"})
        assert len(contradictions) == 0
    ...
    def test_semantic_opposites_contradiction(self):
        ...
        contradictions = detect_contradictions("bot.power", "off", {"bot.power": "on"})
        # Same path = update, not contradiction
        assert len(contradictions) == 0
    ...
    def test_negation_contradiction(self):
        ...
        contradictions = detect_contradictions(
            "user.status", "not active", {"user.status": "active"}
        )
        # Same path = update, not contradiction
        assert len(contradictions) == 0
...
class TestIntegration:
    ...
    def test_full_workflow(self):
        ...
        mem.remember(
            "user.programming_languages", "Python, Go, JavaScript", check_contradictions=False
        )
