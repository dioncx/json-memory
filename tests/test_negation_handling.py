...
class TestSmartMemoryNegation:
    ...
    def test_negation_query_finds_warnings(self, mem):
        ...
        mem.remember(
            "mem.lesson_leverage",
            "Avoid using leverage on Binance - warning",
            tags=["warning", "lesson"],
        )

        # Add normal fact with no warning keywords
        mem.remember(
            "mem.strategy_trading", "Use RSI + MACD strategy for profit", tags=["strategy"]
        )
    ...
    def test_negation_query_finds_mistakes(self, mem):
        ...
        # Add mistake fact
        mem.remember(
            "mem.mistake_sunday", "Sunday trading is consistently poor", tags=["mistake", "lesson"]
        )

        # Add normal fact
        mem.remember("mem.strategy_trading", "Use RSI + MACD strategy", tags=["strategy"])
    ...
    def test_exclusion_query_finds_excluded_thing(self, mem):
        ...
        mem.remember("mem.lesson_leverage", "Leverage can be dangerous", tags=["warning"])

        # Add fact about spot trading
        mem.remember("mem.strategy_spot", "Spot trading is safer", tags=["strategy"])
    ...
    def test_no_negation_query_uses_normal_scoring(self, mem):
        ...
        mem.remember("mem.lesson_leverage", "Avoid using leverage for trading", tags=["warning"])
        mem.remember(
            "mem.strategy_trading", "Use RSI + MACD strategy for trading", tags=["strategy"]
        )
    ...
    def test_negation_with_keyword_matching(self, mem):
        ...
        mem.remember("mem.warning_trading", "Avoid trading on Sundays", tags=["warning"])

        # Add warning fact about cooking
        mem.remember("mem.warning_cooking", "Don't use too much salt", tags=["warning"])
